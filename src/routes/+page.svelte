    ...
    cards: [
      {
        icon: WhyPeople,
        headline: `Our People`,
        text: `All we offer is expertise. Check out our team of problem-solvers.`,
        buttons: [
          {
            url: '/our-team',
            text: 'Meet Our Team',
      ...
      },
      {
        ...
        text: `From B2B to Healthcare, we bring specialized expertise to every industry.`,
        buttons: [
          {
